...
public class frmMantenimientoCon extends javax.swing.JFrame {
                ...
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout
                                        ...
                                        .addComponent(btnRegistrar, javax.swing.GroupLayout.DEFAULT_SIZE, 45,
                                                Short.MAX_VALUE)
                                        .addComponent(txtCodidgo)
                                ...
                                .addGroup(jPanel1Layout
                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(jLabel2, javax.swing.GroupLayout.DEFAULT_SIZE, 45,
                                                Short.MAX_VALUE)
                                ...
                                .addGroup(jPanel1Layout
                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(jLabel3, javax.swing.GroupLayout.DEFAULT_SIZE, 45,
                                                Short.MAX_VALUE)
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(btnCerrar, javax.swing.GroupLayout.PREFERRED_SIZE, 43,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(101, 101, 101)));
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        if (aux != null) {
            JOptionPane.showMessageDialog(rootPane,
                    "El contacto con codifo: " + Integer.valueOf(txtCodidgo.getText()) + " ya ah sido registrado");
        } else {
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnBuscarActionPerformed
        ...
        if (aux != null) {
            ...
            JOptionPane.showMessageDialog(rootPane,
                    "El contaco con codifo: " + Integer.valueOf(txtCodidgo.getText()) + " no encontrado");
        }
    }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (txtCodidgo.getText().trim().isEmpty()) {
            ...
            arbolContacto
                    .setRaiz(arbolContacto.eliminar(arbolContacto.getRaiz(), Integer.parseInt(txtCodidgo.getText())));
            JOptionPane.showMessageDialog(rootPane,
                    "Contacto con codigo: " + Integer.valueOf(txtCodidgo.getText()) + " aliminado");
            txtCodidgo.setText("");
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmMantenimientoCon.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
